...
// তোমার তৈরি করা কাস্টম হেডার ফাইলটি ইনক্লুড করা হলো
include '../includes/header_link.php'; 

$mt_id = $_SESSION['mt'];

// ড্যাশবোর্ডের লাইভ কাউন্টারগুলোর জন্য ডাটাবেজ থেকে কাউন্ট আনা
            ...
            <div class="bg-white p-4 rounded-4 shadow-sm border-start border-primary border-4 d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">
                        ...
                        Active MT ID: <strong class="text-primary"><?php echo htmlspecialchars($mt_id); ?></strong>
                    </p>
                </div>
    ...
    <div class="row g-4 mb-5">
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card h-100 menu-card p-3">
                ...
                <a href="check_test.php" class="btn btn-sm btn-outline-warning w-100 mt-2 rounded-pill fw-bold">View Tickets</a>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card h-100 menu-card p-3">
                ...
                <a href="approved_request.php" class="btn btn-sm btn-outline-primary w-100 mt-2 rounded-pill fw-bold">Manage Queue</a>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card h-100 menu-card p-3">
                ...
                <a href="sample_collected.php" class="btn btn-sm btn-outline-info w-100 mt-2 rounded-pill fw-bold text-dark">Track Testing</a>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card h-100 menu-card p-3">
                ...
                <a href="delivered_report.php" class="btn btn-sm btn-outline-success w-100 mt-2 rounded-pill fw-bold">View History</a>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm rounded-4 p-4 bg-dark text-white mb-4">
                ...
                <div class="d-grid gap-2">
                    <a href="check_test.php" class="btn btn-primary text-start"><i class="fa-solid fa-magnifying-glass-chart me-2"></i> Open Test Verification Room</a>
                </div>
            </div>
        </div>
    </div>
